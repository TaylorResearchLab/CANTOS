...
#Model utilized as recommended:  text-embedding-ada-002

#start user configure

infile = "WHO_Only_terms.csv" #path to input .csv file with only one column w disease names.
...
embeddings_df.to_csv(basename + "_" + modelname + "_" + "embeddings.csv", index=False)
