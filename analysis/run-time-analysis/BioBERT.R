method_name <- "BioBERT+Euclidean Distance"
start_time <- Sys.time()
...
print("BioBERT Distance Matrix Computed")
...
biobert_match_all<- nearest_match_embeddings(distance_matrix_biobert_all,"biobert") # Executed
biobert_match_5th<- nearest_match_embeddings(distance_matrix_biobert_5th,"biobert") # Executed
biobert_match_ncit<- nearest_match_embeddings(distance_matrix_biobert_ncit,"biobert") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("BioBERT Computed")
