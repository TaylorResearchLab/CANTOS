...
save.image(paste(run_time_analysis,"/KMeans_LTE3/5B_5thed.RData",sep=""))
...
Runtime_5B_5th = round(total_elapsed_time, 2)
Memory_gb_5B_5th=round(sum(sizes) / (1024^2), 3)/1000
