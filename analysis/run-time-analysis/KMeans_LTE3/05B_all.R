...
save.image(paste(run_time_analysis,"/KMeans_LTE3/5B_all.RData",sep=""))
...
Runtime_5B_all = round(total_elapsed_time, 2)
Memory_gb_5B_all=round(sum(sizes) / (1024^2), 3)/1000
