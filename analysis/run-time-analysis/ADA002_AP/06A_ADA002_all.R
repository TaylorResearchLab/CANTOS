...
save.image(paste(run_time_analysis,"/ADA002_AP/6A-ADA002_all.RData",sep=""))
...
Runtime_6A_all = round(elapsed_time, 2)
Memory_gb_6a_all=round(sum(sizes) / (1024^2), 3)/1000
