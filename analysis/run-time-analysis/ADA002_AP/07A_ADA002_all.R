...
results_dir <- file.path(run_time_analysis,"results")
...
Runtime_7A_all = round(elapsed_time, 2)
Memory_gb_7a_all=round(sum(sizes) / (1024^2), 3)/1000

print(Runtime_7A_all)
print(Memory_gb_7a_all)


save.image(paste(run_time_analysis,"/ADA002_AP/07A-ADA002_all.RData",sep=""))
