method_name <- "clincalBERT+Euclidean Distance"
start_time <- Sys.time()
...
print("clinicalBERT Distance Matrix")
...
print("clinicalBERT Distance Matrix Computed")

start_time<-Sys.time()
save.image("clinicalBERT.RData")

distance_matrix_clinicalBERT<-as.data.frame(distance_matrix_clinicalBERT) # EXECUTED
...
clinicalBERT_all<- nearest_match_embeddings(distance_matrix_clinicalBERT_all,"clinicalBERT") # Executed
clinicalBERT_5th<- nearest_match_embeddings(distance_matrix_clinicalBERT_5th,"clinicalBERT") # Executed
clinicalBERT_ncit<- nearest_match_embeddings(distance_matrix_clinicalBERT_ncit,"clinicalBERT") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("clinicalBERT Computed")
