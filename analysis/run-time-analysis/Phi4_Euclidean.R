method_name <- "phi4+Euclidean Distance"
start_time <- Sys.time()
...
print("phi4 Distance Matrix Computed")
...
phi4_match_all<- nearest_match_embeddings(distance_matrix_phi_all,"phi4") # Executed
phi4_match_5th<- nearest_match_embeddings(distance_matrix_phi_5th,"phi4") # Executed
phi4_match_ncit<- nearest_match_embeddings(distance_matrix_phi_ncit,"phi4") # Executed
end_time <- Sys.time()
