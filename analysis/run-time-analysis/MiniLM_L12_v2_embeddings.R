method_name <- "all-MiniLM-L12-v2+Euclidean Distance"
start_time <- Sys.time()
...
print("MiniLM_L12_v2_embeddings Loading")
...
print("MiniLM_L12_v2_embeddings Distance Matrix")
...
print("MiniLM_L12_v2 Distance Matrix Computed")

start_time<-Sys.time()
save.image("MiniLM_L12_v2.RData")

distance_matrix_MiniLM_L12_v2<-as.data.frame(distance_matrix_MiniLM_L12_v2) # EXECUTED
...
all_MiniLM_L12_v2_all<- nearest_match_embeddings(distance_matrix_MiniLM_L12_v2_all,"MiniLM_L12_v2") # Executed
all_MiniLM_L12_v2_5th<- nearest_match_embeddings(distance_matrix_MiniLM_L12_v2_5th,"MiniLM_L12_v2") # Executed
all_MiniLM_L12_v2_ncit<- nearest_match_embeddings(distance_matrix_MiniLM_L12_v2_ncit,"MiniLM_L12_v2") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("MiniLM_L12_v2 Computed")
