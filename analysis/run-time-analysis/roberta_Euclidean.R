method_name <- "all-roberta-large-v1+Euclidean Distance"
start_time <- Sys.time()
...
print("roberta Distance Matrix Computed")

save.image("roberta.RData")

start_time<-Sys.time()

distance_matrix_roberta<-as.data.frame(distance_matrix_roberta) # EXECUTED
...
print("all match roberta")
roberta_match_all<- nearest_match_embeddings(distance_matrix_roberta_all,"roberta") # Executed
print("5th match roberta")
roberta_match_5th<- nearest_match_embeddings(distance_matrix_roberta_5th,"roberta") # Executed
print("ncit match roberta")
roberta_match_ncit<- nearest_match_embeddings(distance_matrix_roberta_ncit,"roberta") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("roberta Computed")
