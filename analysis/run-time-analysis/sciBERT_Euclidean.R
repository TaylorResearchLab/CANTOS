method_name <- "sciBERT+Euclidean Distance"
start_time <- Sys.time()
...
print("sciBERT_embeddings Loading")
...
print("sciBERT_embeddings Distance Matrix")
...
print("sciBERT Distance Matrix Computed")

start_time<-Sys.time()
save.image("sciBERT.RData")

distance_matrix_sciBERT<-as.data.frame(distance_matrix_sciBERT) # EXECUTED
...
sciBERT_all<- nearest_match_embeddings(distance_matrix_sciBERT_all,"sciBERT") # Executed
sciBERT_5th<- nearest_match_embeddings(distance_matrix_sciBERT_5th,"sciBERT") # Executed
sciBERT_ncit<- nearest_match_embeddings(distance_matrix_sciBERT_ncit,"sciBERT") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("sciBERT Computed")
