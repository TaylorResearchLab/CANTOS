method_name <- "lama_32_3b+Euclidean Distance"
start_time <- Sys.time()
...
print("lama_32_3b Distance Matrix")
...
print("lama_32_3b Distance Matrix Computed")
...
llama32_match_all<- nearest_match_embeddings(distance_matrix_llama32_all,"llama32") # Executed
llama32_match_5th<- nearest_match_embeddings(distance_matrix_llama32_5th,"llama32") # Executed
llama32_match_ncit<- nearest_match_embeddings(distance_matrix_llama32_ncit,"llama32") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("lama_32_3b Computed")
