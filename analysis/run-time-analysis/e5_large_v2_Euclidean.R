method_name <- "e5_large_v2+Euclidean Distance"
start_time <- Sys.time()
...
print("e5_large_embeddings Loading")
...
print("e5_large_embeddings Distance Matrix")
...
print("e5_large_embeddings Distance Matrix Computed")

start_time<-Sys.time()
save.image("e5_large_embeddings.RData")

distance_matrix_e5large_v2<-as.data.frame(distance_matrix_e5large_v2) # EXECUTED
...
e5_large_v2_match_all<- nearest_match_embeddings(distance_matrix_e5large_v2_all,"e5_large_v2") # Executed
e5_large_v2_match_5th<- nearest_match_embeddings(distance_matrix_e5large_v2_5th,"e5_large_v2") # Executed
e5_large_v2_match_ncit<- nearest_match_embeddings(distance_matrix_e5large_v2_ncit,"e5_large_v2") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("e5_large_v2 Computed")
