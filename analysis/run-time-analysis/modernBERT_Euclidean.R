method_name <- "ModernBERT+Euclidean Distance"
start_time <- Sys.time()
...
print("modernBERT Distance Matrix")
...
print("modernBERT Distance Matrix Computed")

save.image("modernBERT.RData")
...
print("all match modernBERT")
modernBERT_match_all<- nearest_match_embeddings(distance_matrix_modernbert_all,"modernBERT") # Executed
print("5th match modernBERT")
modernBERT_match_5th<- nearest_match_embeddings(distance_matrix_modernbert_5th,"modernBERT") # Executed
print("ncit match modernBERT")
modernBERT_match_ncit<- nearest_match_embeddings(distance_matrix_modernbert_ncit,"modernBERT") # Executed
