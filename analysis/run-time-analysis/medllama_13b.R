method_name <- "MedLlama_13B+Euclidean Distance"
start_time <- Sys.time()
...
print("MedLlama_13b Distance Matrix")
...
print("MedLlama_13b Distance Matrix Computed")
...
medllama_match_all<- nearest_match_embeddings(distance_matrix_medllama_all,"medllama") # Executed
medllama_match_5th<- nearest_match_embeddings(distance_matrix_medllama_5th,"medllama") # Executed
medllama_match_ncit<- nearest_match_embeddings(distance_matrix_medllama_ncit,"medllama") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("MedLlama_13b Computed")
