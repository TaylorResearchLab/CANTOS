method_name <- "LaBSE+Euclidean Distance"
start_time <- Sys.time()
...
print("LaBSE Distance Matrix Computed")

start_time<-Sys.time()
save.image("LaBSE.RData")


distance_matrix_labse<-as.data.frame(distance_matrix_labse) # EXECUTED
...
LaBSE_all<- nearest_match_embeddings(distance_matrix_labse_all,"LaBSE") # Executed
LaBSE_5th<- nearest_match_embeddings(distance_matrix_labse_5th,"LaBSE") # Executed
LaBSE_ncit<- nearest_match_embeddings(distance_matrix_labse_ncit,"LaBSE") # Executed

end_time <- Sys.time()
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("LaBSE Computed")
