#Detect if Affinity cluster members are outliers using LOF and Isolation Forest on V3 data
...
# Load affinity clusters for  V3
affinity_cluster_v3_df <- read.csv(paste(intermediate_dir,"/affinity_cluster_v3_df_5thed.csv",sep="")) # 10 cols
...
elapsed_time<- as.numeric(difftime(stop_time_1, start_time_1, units = "secs"))
