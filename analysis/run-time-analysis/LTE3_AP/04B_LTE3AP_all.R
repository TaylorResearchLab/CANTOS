...
start_time_4B_all<-Sys.time()
print("Script 4b_all running")
...
# Save this file "
end_time_4B_all<-Sys.time()
elapsed_time<- as.numeric(difftime(end_time_4B_all, start_time_4B_all, units = "secs"))
...
Runtime_4B_all = round(elapsed_time, 2)
Memory_gb_4B_all=round(sum(sizes) / (1024^2), 3)/1000
save.image(paste(run_time_analysis,"/4B_all.RData",sep=""))
