...
Runtime_4B_5th = round(elapsed_time, 2)
Memory_gb_4B_5th=round(sum(sizes) / (1024^2), 3)/1000
save.image(paste(run_time_analysis,"/KMeans_LTE3/4B_5th.RData",sep=""))
