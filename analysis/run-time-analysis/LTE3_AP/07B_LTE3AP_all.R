...
save.image(paste(run_time_analysis,"/LTE3_AP/07B-LTE3_all.RData",sep=""))
...
Runtime_7B_all = round(elapsed_time, 2)
Memory_gb_7b_all=round(sum(sizes) / (1024^2), 3)/1000

print(Runtime_7B_all)
print(Memory_gb_7b_all)
