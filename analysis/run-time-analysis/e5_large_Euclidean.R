method_name <- "e5_large+Euclidean Distance"
start_time <- Sys.time()
...
distance_matrix_e5_large<-as.data.frame(distance_matrix_e5_large) # EXECUTED
...
e5_large_match_all<- nearest_match_embeddings(distance_matrix_e5_large_all,"e5_large") # Executed
e5_large_match_5th<- nearest_match_embeddings(distance_matrix_e5_large_5th,"e5_large") # Executed
e5_large_match_ncit<- nearest_match_embeddings(distance_matrix_e5_large_ncit,"e5_large") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("e5_large Computed")
