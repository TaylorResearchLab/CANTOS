method_name <- "deepseek_8b+Euclidean Distance"
start_time <- Sys.time()
...
print("deepseek_8b Distance Matrix")
...
print("deepseek_8b Distance Matrix Computed")

save.image("deepseek_8b_embeddings.RData")

start_time<-Sys.time()

distance_matrix_deepseek<-as.data.frame(distance_matrix_deepseek) # EXECUTED
