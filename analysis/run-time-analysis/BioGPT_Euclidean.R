method_name <- "BioGPT+Euclidean Distance"
start_time <- Sys.time()
...
print("BioGPT Distance Matrix Computed")

start_time<-Sys.time()
save.image("BioGPT.RData")

distance_matrix_BioGPT<-as.data.frame(distance_matrix_BioGPT) # EXECUTED
...
BioGPT_all<- nearest_match_embeddings(distance_matrix_BioGPT_all,"BioGPT") # Executed
BioGPT_5th<- nearest_match_embeddings(distance_matrix_BioGPT_5th,"BioGPT") # Executed
BioGPT_ncit<- nearest_match_embeddings(distance_matrix_BioGPT_ncit,"BioGPT") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("BioGPT Computed")
