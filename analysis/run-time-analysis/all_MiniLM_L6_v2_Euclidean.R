method_name <- "all_MiniLM_L6_v2+Euclidean Distance"
start_time <- Sys.time()
...
print("all_MiniLM_L6_v2_embeddings Loading")
...
print("all_MiniLM_L6_v2_embeddings Distance Matrix")
...
print("all_MiniLM_L6_v2_embeddings Distance Matrix Computed")

start_time<-Sys.time()
save.image("all_MiniLM_L6_v2_embeddings.RData")

distance_matrix_all_MiniLM_L6_v2<-as.data.frame(distance_matrix_all_MiniLM_L6_v2) # EXECUTED


distance_matrix_all_MiniLM_L6_v2_all <- distance_matrix_all_MiniLM_L6_v2 %>% dplyr::select(all_of(WHO_Terms_All$Tumor_Names))
distance_matrix_all_MiniLM_L6_v2_5th <- distance_matrix_all_MiniLM_L6_v2 %>% dplyr::select(all_of(WHO_Terms_5th$Tumor_Names))
distance_matrix_all_MiniLM_L6_v2_ncit <- distance_matrix_all_MiniLM_L6_v2 %>% dplyr::select(all_of(ncit_terms$Tumor_Names))


all_MiniLM_L6_v2_match_all<- nearest_match_embeddings(distance_matrix_all_MiniLM_L6_v2_all,"all_MiniLM_L6_v2") # Executed
all_MiniLM_L6_v2_match_5th<- nearest_match_embeddings(distance_matrix_all_MiniLM_L6_v2_5th,"all_MiniLM_L6_v2") # Executed
all_MiniLM_L6_v2_match_ncit<- nearest_match_embeddings(distance_matrix_all_MiniLM_L6_v2_ncit,"all_MiniLM_L6_v2") # Executed
end_time <- Sys.time()
elapsed_time4<- as.numeric(difftime(end_time, start_time, units = "secs"))

print("all_MiniLM_L6_v2 Computed")
