...
rm(list=setdiff(ls(), c("Kmeans_silhouette_all_edition_ada2","a1","title_size","axis_size","red_dot_size")))
...
rm(list=setdiff(ls(), c("Kmeans_silhouette_all_edition_ada2","a1","Kmeans_silhouette_5th_edition_ada2","title_size","axis_size","red_dot_size")))
...
rm(list=setdiff(ls(), c("Kmeans_silhouette_all_edition_ada2","a1","Kmeans_silhouette_5th_edition_ada2","a2",
                        "Kmeans_silhouette_all_edition_v3","title_size","axis_size","red_dot_size")))
